...
// external libs
var libs = {
    js: ['_libs/1_libraryA/script.js', '_libs/2_libraryB/script.min.js'],
    css: ['_libs/2_libraryB/style.min.css']
};
...
gulp.task('js-test-jest', function () {
    return gulp.src('_tests/_build').pipe(
        jest({
...
gulp.task('watch', function () {
    gulp.watch('./_html/*.html', function () {
        runSequence('html');
    });
    gulp.watch('./_scss/**/*.scss', function () {
        runSequence('css', 'css-libs', 'css-critical');
    });
    gulp.watch(['./_js/*.js', './_vue/**/*.vue', './_vue/**/*.js'], function () {
        runSequence('js', 'js-babel', 'js-test', 'js-libs');
    });
